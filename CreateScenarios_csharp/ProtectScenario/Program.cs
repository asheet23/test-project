...
namespace ProtectScenario
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var normalDiscountRates = worksheet.Scenarios.Add("Normal Discount Rates", worksheet.Range["D2:D6"], normalDiscountRatesValues, locked: false);

            // Create a scenario with selling without discount.
            // The changing cells are D2:D6.
            var sellingWithoutDiscountValues = new List<object> { 0, 0, 0, 0, 0 };
            var sellingWithoutDiscount = worksheet.Scenarios.Add("Selling Without Discount", worksheet.Range["D2:D6"], sellingWithoutDiscountValues, locked: false);
            ...
            var bulkQuantitySold = worksheet.Scenarios.Add("Bulk Quantity Sold", worksheet.Range["E2:E6"], bulkQuantitySoldValues, locked: false);

            // Save the workbook.
            workbook.Save("ProtectScenario.xlsx");
        }
    }
}
